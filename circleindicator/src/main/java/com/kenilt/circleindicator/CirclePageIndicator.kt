...
package com.kenilt.circleindicator
...
class CirclePageIndicator @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = R.attr.vpiCirclePageIndicatorStyle) : View(context, attrs, defStyle), PageIndicator {
    ...
    init {
        if (!isInEditMode) {
            ...
            val res = resources
            val defaultPageColor = R.color.default_circle_indicator_page_color
            val defaultFillColor = R.color.default_circle_indicator_fill_color
            val defaultOrientation = res.getInteger(R.integer.default_circle_indicator_orientation)
            val defaultStrokeColor = R.color.default_circle_indicator_stroke_color
            ...
            mPaintPageFill.color = a.getColor(R.styleable.CirclePageIndicator_pageColor, ContextCompat.getColor(context, defaultPageColor))
            mPaintStroke.style = Style.STROKE
            mPaintStroke.color = a.getColor(R.styleable.CirclePageIndicator_strokeColor, ContextCompat.getColor(context, defaultStrokeColor))
            ...
            mPaintFill.color = a.getColor(R.styleable.CirclePageIndicator_fillColor, ContextCompat.getColor(context, defaultFillColor))
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        val count = mViewPager?.adapter?.count ?: return
